...
def main() -> None:
    ...
    ap.add_argument("--label", default="appcast", help="Release Label (default: appcast)")
    ap.add_argument("--origin", default="appcast", help="Release Origin (default: appcast)")
    ap.add_argument("--desc", default="appcast repository", help="Release Description")
    args = ap.parse_args()
